...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOA, MASSAGERLED_Pin | GPIO_PIN_6, GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : MASSAGERLED_Pin PA6 */
    GPIO_InitStruct.Pin = MASSAGERLED_Pin | GPIO_PIN_6;
